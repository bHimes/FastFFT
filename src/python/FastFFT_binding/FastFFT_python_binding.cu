...
template <class ComputeType, class PositionSpaceType, class OtherImageType>
void declare_array(py::module& m, const std::string& typestr) {

    using FT_t = FastFFT::FourierTransformer<ComputeType, PositionSpaceType, OtherImageType>;
